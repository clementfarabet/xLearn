--------------------------------------------------------------------------------
-- DataList: a class to handle several datasets.
-- where each dataset belongs to a class
-- 
-- Authors: BenCorda, ClemFarabet
--------------------------------------------------------------------------------

--- creates a class "DataList"
do
   local DataList, parent = torch.class('DataList','DataSet')
   ...
   -- self[item]: handler for get item  
